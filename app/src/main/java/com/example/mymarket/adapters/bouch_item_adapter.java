...
public class bouch_item_adapter extends BaseAdapter {
    ...
    public bouch_item_adapter(Context context,List<epic_item> itepice){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        itemIconView.setOnClickListener(new OnClickListener() {
            @Override
